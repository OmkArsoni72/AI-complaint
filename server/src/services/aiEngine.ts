...
const CATEGORY_RULES: { keywords: string[]; category: string }[] = [
  ...
  { 
    keywords: ['safety', 'crime', 'police', 'robbery', 'assault', 'theft', 'harassment', 'rape', 'raped', 'rapped', 'danger', 'murder', 'homicide', 'kill', 'killed', 'stabbing', 'shooting', 'kidnap', 'abduction', 'chor', 'shakti', 'khatra'], 
...
const HIGH_PRIORITY_KEYWORDS = [
  ...
  'rape', 'raped', 'rapped', 'murder', 'homicide', 'kill', 'killed', 'stabbing', 'shooting', 'gun', 'weapon',
